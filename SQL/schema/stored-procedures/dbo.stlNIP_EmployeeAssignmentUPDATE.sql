...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stlNIP_EmployeeAssignmentUPDATE]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[stlNIP_EmployeeAssignmentUPDATE] AS' 
END
-- =============================================
-- Author:		jeff rupp
...
-- =============================================
ALTER PROCEDURE [dbo].[stlNIP_EmployeeAssignmentUPDATE] 
...
BEGIN TRANSACTION
	...
	UPDATE stlNIP_EmployeeAssignments
