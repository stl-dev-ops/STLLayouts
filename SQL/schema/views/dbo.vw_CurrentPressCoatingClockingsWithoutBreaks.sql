...
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vw_CurrentPressCoatingClockingsWithoutBreaks]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.vw_CurrentPressCoatingClockingsWithoutBreaks
AS
