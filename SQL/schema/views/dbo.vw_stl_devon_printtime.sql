...
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vw_stl_devon_printtime]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.vw_stl_devon_printtime
AS
SELECT     dbo.vw_stl_devon_printtime0.wn___ref, dbo.vw_stl_devon_printtime0.datum___, dbo.vw_stl_devon_printtime0.datum___ AS ToDate, 
                      ...
                      CASE WHEN vw_stl_devon_printtime0.ActLunch IS NULL THEN 0 ELSE vw_stl_devon_printtime0.ActLunch END AS ActLunch, 
                      CASE WHEN vw_stl_devon_printtime0.ActInterruptions IS NULL THEN 0 ELSE vw_stl_devon_printtime0.ActInterruptions END AS ActInterruptions, 
                      ...
                      THEN 0 ELSE vw_stl_devon_op.oflinsvo END) / vw_stl_devon_op.Printing END AS estftpermin
FROM         dbo.vw_stl_devon_printtime0 LEFT OUTER JOIN
                      ...
                      dbo.vw_stl_devon_printtime0.wn___ref = dbo.vw_stl_devon_op_act.wn___ref AND dbo.vw_stl_devon_printtime0.datum___ = dbo.vw_stl_devon_op_act.dat__beg
' 
