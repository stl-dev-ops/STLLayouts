...
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vw_CurrentCoatingClockings]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.vw_CurrentCoatingClockings
AS
