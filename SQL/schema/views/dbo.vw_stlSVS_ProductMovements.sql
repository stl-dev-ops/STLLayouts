...
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vw_stlSVS_ProductMovements]'))
EXEC dbo.sp_executesql @statement = N'

CREATE VIEW [dbo].[vw_stlSVS_ProductMovements] AS 

SELECT r.[Date], r.Movement, r.ProductID, p.zynrefkl [ProductDescription], r.Quantity, r.JobID, r.OrderID, r.SalesOrderID, r.Customer, 
