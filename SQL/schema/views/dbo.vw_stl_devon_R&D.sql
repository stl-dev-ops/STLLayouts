...
IF NOT EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vw_stl_devon_R&D]'))
EXEC dbo.sp_executesql @statement = N'CREATE VIEW dbo.[vw_stl_devon_R&D]
AS
