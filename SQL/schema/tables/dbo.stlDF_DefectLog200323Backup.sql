...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[stlDF_DefectLog200323Backup]') AND type in (N'U'))
BEGIN
CREATE TABLE [dbo].[stlDF_DefectLog200323Backup](
